...
test('it renders enum type and its variants', () => {
    ...
    codeContains(getFromRenderMap(renderMap, 'lib/types/tag/tag.dart'), [
        'class Tag {',
        'factory Tag.uninitialized() {',
        'factory Tag.account() {',
        'Uint8List toBorsh() {',
        '@BEnum<Tag>({Uninitialized: BUninitialized(), Account: BAccount()}) required Tag myEnum,',
    ]);

    codeContains(getFromRenderMap(renderMap, 'lib/types/tag/uninitialized.dart'), [
        'class Uninitialized {',
    ...
    codeContains(getFromRenderMap(renderMap, 'lib/types/tag/account.dart'), [
        'class Account {',
